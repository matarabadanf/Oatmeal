...
np.savetxt('../He_kin_21s.dat', kin)
np.savetxt('../He_vnuc_21s.dat', vnuc)
np.savetxt('../He_S_21s.dat', overlap)
np.save('../He_eri_21s.npy', eri) # cannot He savetxt, has to He np binary
